  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        >
          <TouchableOpacity onPress={() => this.props.navigation.navigate('DrawerOpen')} style={{ flex: 0.15, alignItems: 'center' }}>
        ...
        >
          ...
          >
            <Text style={[{ fontWeight: 'bold' }, this.state.page === 'request' && { color: '#ffffff' }]}>My Request</Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <Text style={[{ fontWeight: 'bold' }, this.state.page === 'task' && { color: '#ffffff' }]}>My Task</Text>
          </TouchableOpacity>
        </View>

        <ScrollView style={{ flex: 1 }}>{displayedPage}</ScrollView>
        <ActionButton buttonColor="#333333">
          <ActionButton.Item buttonColor="#333333" title="New Task" onPress={() => navigate('RequestForm')}>
