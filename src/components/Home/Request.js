...
const ApplicationSingle = ({ number, name, travelType }) => (
  ...
  >
    <View style={{ width: "80%" }}>
      <Text style={{ fontSize: 10, paddingBottom: 8, color: "white" }}>
        {number}
      </Text>
      <Text style={{ fontSize: 20, paddingBottom: 8, color: "white" }}>
        {name}
      </Text>
      <Text style={{ fontSize: 14, paddingBottom: 16, color: "white" }}>
        {travelType}
      </Text>
    </View>
    <TrackingBar />
