...
import { StyleSheet, Text, TextInput, View, TouchableOpacity, ScrollView, KeyboardAvoidingView, Alert } from 'react-native'
    ...
    return (
      <KeyboardAvoidingView behavior="padding" style={{ flex: 1, backgroundColor: '#ffffff' }}>
        ...
        <View style={{ paddingVertical: 16, paddingHorizontal: 16 }}>
          <Text style={{ fontSize: 14, fontWeight: 'bold' }}>Step 3: Cost Information</Text>
        </View>
        ...
        <ScrollView style={{ flex: 1 }}>
          ...
          <View style={{ paddingHorizontal: 16, paddingBottom: 16 }}>
            <Text style={{ fontSize: 12, paddingVertical: 16 }}>Cost Centre</Text>
          ...
          <View style={{ paddingHorizontal: 16, paddingBottom: 16 }}>
            <Text style={{ fontSize: 12, paddingVertical: 16 }}>Cost Category</Text>
            <View style={{ borderColor: '#c4c4c4' }}>
              <Dropdown
                ...
                label=""
                data={data}
                onChangeText={() => this.setState({ data: 'External Sponsorship' })}
              />
